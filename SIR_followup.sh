...
echo ">> Sweeping Job 1 checkpoints into backup folder..."
mkdir -p datasets/ILIAS/checkpoints_old
mv datasets/ILIAS/checkpoints/*.pkl datasets/ILIAS/checkpoints_old/ 2>/dev/null || true
echo ">> Sweep complete. Booting clean grid search."
